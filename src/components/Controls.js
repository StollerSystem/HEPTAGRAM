  ...
  return (
    ...
    <div className="controlBox">
      ...
      <div className="synthControls">
        ...
        <p>RELEASE<input type="range" min="0" max="30" defaultValue="5" className="slider" id="release1"/></p> 
      ...
      <div className="synthControls">
        ...
        <p>RELEASE<input type="range" min="0" max="30" defaultValue="5" className="slider" id="release2"/></p> 
