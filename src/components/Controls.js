...
function Controls(props) {
  ...
  return (
    ...
    <div className="controlBox">
      ...
      <p>DLY LVL<input type="range" min="0" max="60" defaultValue="0" className="slider" id="delayLevel"/></p> 
      <div className="synthControls">
        ...
        <p>PATTERN<input type="range" min="1" max="3" defaultValue="1" className="slider" id="pattern1"/></p>
      </div>
      <div className="synthControls">
        <p>SYNTH 2</p>
        ...
        <p>PATTERN<input type="range" min="1" max="3" defaultValue="1" className="slider" id="pattern2"/></p>
      </div>
